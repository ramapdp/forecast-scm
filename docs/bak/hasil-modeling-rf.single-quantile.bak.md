> **ARSIP — jangan dibaca sebagai hasil yang berlaku.** Dokumen ini adalah
> `docs/hasil-modeling-rf.md` versi run kuantil-tunggal (19 Agu 2026), diberi
> akhiran `.single-quantile.bak` pada 2026-08-25 saat run multi-kuantil butir 0c
> selesai. Hasil yang berlaku ada di `docs/hasil-modeling-rf.md`.
>
> Angka di sini **tidak boleh disandingkan langsung** dengan angka di dokumen
> baru: kriterianya berbeda besaran. Di sini pinball@0.9 (satu titik kuantil);
> di sana K1 = rata-rata pinball lintas 19 titik `QUANTILE_SET_A`. Larangan
> ini tercatat sebagai T-10 di `docs/todolist-proyek.md`.
>
